...
@section('content')
    ...
    <div class="alert alert-jim" id="inputText">
        <h2 class="page-header">Accepted Documents</h2>
        <form class="form-inline" method="POST" action="{{ asset('documents/report/allaccepted/{id}/{year}/{month}') }}" onsubmit="return searchDocument()">
            {{ csrf_field() }}
            <div class ="printhide">
               <div class="row">
                    <div class="col-md-6">
                        ...
                        <a href="{{ asset('documents/report/allaccepted/'.$id.'/'.$year.'/'.$month)}}" class="btn btn-info form-control">
                        View All</a>
                        @endif -->
