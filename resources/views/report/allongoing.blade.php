...
@section('content')
    ...
    <div class="alert alert-jim" id="inputText">
        ...
        <form class="form-inline" method="POST" action="{{ asset('documents/report/allongoingsearch') }}" onsubmit="return searchDocument()">
            {{ csrf_field() }}
            <div class ="printhide">
               <div class="row">
                    <div class="col-md-6">
                        ...
                        <a href="{{ asset('documents/report/allongoinghome/')}}" class="btn btn-info form-control">
                        View All</a>
                        @endif
